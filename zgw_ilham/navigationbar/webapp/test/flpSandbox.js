					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "NavBar",
									"targetURL": "#navigationbar-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"navigationbar-display": {
								"semanticObject": "navigationbar",
								"action": "display",
								"description": "Explore using Navbar",
								"title": "NavBar",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=navigationbar",
									"url": sap.ui.require.toUrl("navigationbar")
								}
							}
						}
					}
