		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GYS API",
									"targetURL": "#grpsrvgrpsrv-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"grpsrvgrpsrv-display": {
								"semanticObject": "grpsrvgrpsrv",
								"action": "display",
								"description": "Fiori Using ZGW_SAP_GRP_SRV",
								"title": "GYS API",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=grpsrv.grpsrv",
									"url": sap.ui.require.toUrl("grpsrv/grpsrv")
								}
							}
						}
					}
