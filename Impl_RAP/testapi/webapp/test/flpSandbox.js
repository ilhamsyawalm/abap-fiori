					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Testing API using RAP",
									"targetURL": "#testapi-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"testapi-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testapi",
									"url": sap.ui.require.toUrl("testapi")
								}
							}
						}
					}
